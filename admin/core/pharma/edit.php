...
if($row 		= mysqli_fetch_assoc($db_data->result)){
    $pha_nhom_duoc_ly_id = $row['pha_nhom_duoc_ly_id'];
...
$html_page .= $form->text(array(
    ...
    'value'=>$pha_name, //giá trị hiện thời của input
...
$html_page .= $form->text(array(
    ...
    'value'=>$pha_title, //giá trị hiện thời của input
    'require'=>1, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
...
$html_page .= $form->textarea(array(
    'label'=>'Mô tả', //tên của input
    'name'=>'pha_description', //tên form của input
    'id'=>'pha_description',//id html của input
    'value'=>$pha_description, //giá trị hiện thời của input
    'require'=>0, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'Mô tả thuốc', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
));
$html_page .= $form->textarea(array(
    'label'=>'Nội dung', //tên của input
    'name'=>'pha_content', //tên form của input
    'id'=>'pha_content',//id html của input
    'value'=>$pha_content, //giá trị hiện thời của input
    'require'=>0, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'Nội dung thuốc', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
));
$html_page .= $form->text(array(
    ...
    'value'=>$pha_so_dang_ky, //giá trị hiện thời của input
    'require'=>1, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
...
$html_page .= $form->text(array(
    ...
    'value'=>$pha_dang_bao_che, //giá trị hiện thời của input
    'require'=>1, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
...
$html_page .= $form->text(array(
    ...
    'value'=>$pha_dong_goi, //giá trị hiện thời của input
    'require'=>0, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
...
$html_page .= $form->text(array(
    ...
    'value'=>$pha_gia_buon, //giá trị hiện thời của input
    'require'=>0, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
...
$html_page .= $form->text(array(
    ...
    'value'=>$pha_gia_le, //giá trị hiện thời của input
    'require'=>0, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
...
$html_page .= $form->text(array(
    ...
    'value'=>$pha_nha_sx_name, //giá trị hiện thời của input
    'require'=>0, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
...
$html_page .= $form->text(array(
    ...
    'value'=>$pha_nha_dk_name, //giá trị hiện thời của input
    'require'=>0, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
...
$html_page .= $form->text(array(
    ...
    'value'=>$check_name_ndl, //giá trị hiện thời của input
    'require'=>1, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
...
$html_page .= $form->textarea(array(
    ...
    'value'=>$pha_thanh_phan, //giá trị hiện thời của input
    'require'=>1, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
...
$html_page .= $form->text(array(
    ...
    'value'=>$pha_ham_luong, //giá trị hiện thời của input
    'require'=>0, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
...
$html_page .= $form->textarea(array(
    ...
    'value'=>$pha_chi_dinh, //giá trị hiện thời của input
    'require'=>1, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
...
$html_page .= $form->textarea(array(
    ...
    'value'=>$pha_chong_chi_dinh, //giá trị hiện thời của input
    'require'=>0, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
...
$html_page .= $form->textarea(array(
    ...
    'value'=>$pha_tuong_tac_thuoc, //giá trị hiện thời của input
    'require'=>0, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
...
$html_page .= $form->textarea(array(
    ...
    'value'=>$pha_tac_dung_phu, //giá trị hiện thời của input
    'require'=>0, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
...
$html_page .= $form->textarea(array(
    ...
    'value'=>$pha_chu_y_de_phong, //giá trị hiện thời của input
    'require'=>0, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
...
$html_page .= $form->textarea(array(
    ...
    'value'=>$pha_lieu_luong, //giá trị hiện thời của input
    'require'=>0, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
...
$html_page .= $form->textarea(array(
    ...
    'value'=>$pha_bao_quan, //giá trị hiện thời của input
    'require'=>0, //yêu cầu nhập hay ko - cái này khai báo thì check = javascript
    'placeholder'=>'', //placeholder của html,
    'isdatepicker'=>0, //hiển thị lịch để chọn ngày tháng năm
    'helpblock'=>'', //đoạn text hướng dẫn hiển thị ngay dưới input
...
$html_page .= $form->ajaxUploadFile(array(
    ...
    'value'=>get_picture_path($pha_image)
));
$html_page .= $form->text(array(
